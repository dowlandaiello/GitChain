...
public class BlockchainTest {
    ...
    public void TestBlockchain() {
        ...
        assertTrue("genesis block in blocks must not be null", blockchain.GetLastBlock() != null); // Ensure genesis not
                                                                                                   // null
    ...
    public void TestCreateNewBlock() {
        ...
        System.out.println(
                genesisStartingTime + ": making genesis block (this shouldn't take more than 25 seconds)...\n"); // Log
                                                                                                                 // gen
                                                                                                                 // time

        Blockchain blockchain = new Blockchain(chainConfig); // Make new blockchain

        System.out.println(System.currentTimeMillis() / 1000 + ": finished making genesis block with difficulty "
                + blockchain.GenesisBlock.Difficulty + ", nonce " + blockchain.GenesisBlock.Nonce + " and block time "
                + (blockchain.GenesisBlock.Timestamp - genesisStartingTime)); // Log start time
        ...
        for (int x = 1; x != numBlocks + 1; x++) { // Make all blocks
            ...
            System.out.println(System.currentTimeMillis() / 1000 + ": finished making block " + x + " with difficulty "
                    + newBlock.Difficulty + ", nonce " + newBlock.Nonce + ", and block time "
                    + (newBlock.Timestamp - lastBlock.Timestamp)); // Log finish time
        ...
        System.out.println("\nfinished making " + numBlocks + " blocks with an average difficulty of "
                + totalDifficulty / numBlocks + ", an average nonce of " + totalNonce / numBlocks
                + ", and an average block time of " + totalBlockTime / numBlocks + " in "
                + (System.currentTimeMillis() / 1000 - blockchain.GenesisBlock.Timestamp) + " seconds."); // Log test
                                                                                                          // finished
    }
